      ...
      <View style={styles.overlay}>
        <View style={styles.card}>
          <BlurView intensity={90} tint="dark" experimentalBlurMethod="dimezisBlurView" style={styles.blur}>
            ...
            <Pressable onPress={onEnable} disabled={enabling} style={{ width: "100%" }}>
              <LinearGradient colors={BTN_GRADIENT} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.enableBtn, enabling && { opacity: 0.7 }]}>
                {enabling ? (
...
const styles = StyleSheet.create({
  ...
  enableBtn: { height: 52, borderRadius: 15, alignItems: "center", justifyContent: "center" },
  enableText: { color: "#fff", fontWeight: "800", fontSize: 16 },
